    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pay_method', models.SmallIntegerField(verbose_name='支付方式', default=3, choices=[(1, '货到付款'), (2, '微信支付'), (3, '支 付 宝'), (4, '银联支付')])),
                ...
                ('transit_price', models.DecimalField(verbose_name='运费价格', max_digits=10, decimal_places=2)),
