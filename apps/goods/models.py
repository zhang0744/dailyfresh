...
class GoodsType(BaseModel):
    ...
    image = models.ImageField(upload_to='GoodsType', verbose_name='商品种类图片')
...
class GoodsSKU(BaseModel):
    ...
    goodsSPU = models.ForeignKey('GoodsSPU', verbose_name='商品SPU')
...
class GoodsSPU(BaseModel):
    ...
    detail = HTMLField(blank=True, verbose_name='商品详情')  # 富文本类型
